...
from scripts.torch.train_rwalk import train_rwalk as train
...
for tasks in train_on:
    ...
    for task in tasks:
        ...
        img_list = f'/home/aranem_locale/Desktop/MICCAI_2023/experiments/UNet_VxM_rwalk/list_files/{mappings[task]}/train_list.txt'
        seg_list = f'/home/aranem_locale/Desktop/MICCAI_2023/experiments/UNet_VxM_rwalk/list_files/{mappings[task]}/train_seg.txt'
        out_folder = f'/home/aranem_locale/Desktop/MICCAI_2023/experiments/UNet_VxM_rwalk/unet_torch_250_{built_ts}_ce_rwalk'
