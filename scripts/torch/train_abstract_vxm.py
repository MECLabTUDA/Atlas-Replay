...
"""
import sys, os
from scripts.torch.train import train
from pythonbots.TelegramBot import TelegramBot

# --> Atlas Replay method uses 110 to 116 <-- #
...
train_on = [['joint']]
# train_on = [['110'], ['111'], ['112'], ['113'], ['114'], ['115'], ['116'], ['joint'],
#             ['110', '111'],
#             ['110', '111', '112'],
#             ['110', '111', '112', '113'],
#             ['110', '111', '112', '113', '114'],
...
for tasks in train_on:
    ...
    for task in tasks:
        ...
        img_list = f'/home/aranem_locale/Desktop/MICCAI_2023/experiments/VoxelMorph_rigid/list_files/{mappings[task]}/train_list.txt'
        seg_list = f'/home/aranem_locale/Desktop/MICCAI_2023/experiments/VoxelMorph_rigid/list_files/{mappings[task]}/train_seg.txt'
        out_folder = f'/home/aranem_locale/Desktop/MICCAI_2023/experiments/VoxelMorph_rigid/vxm_torch_250_{built_ts}_ncc_ce'
        ...
        sys.argv = args
        if continue_:
            TBot.send_msg(f"Start training {out_folder} using the registration network and prev_model {load_model}..")
        else:
            TBot.send_msg(f"Start training {out_folder} using the registration network..")
        train()
