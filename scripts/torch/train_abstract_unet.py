...
# train_on = [['111'], ['112'], ['113'], ['115'], ['116'], ['joint'],
#             # ['110', '111'],
#             # ['110', '111', '112'],
#             # ['110', '111', '112', '113'],
#             # ['110', '111', '112', '113', '114'],
...
for tasks in train_on:
    ...
    for task in tasks:
        ...
        img_list = f'/home/aranem_locale/Desktop/MICCAI_2023/experiments/UNet_VxM/list_files/{mappings[task]}/train_list.txt'
        seg_list = f'/home/aranem_locale/Desktop/MICCAI_2023/experiments/UNet_VxM/list_files/{mappings[task]}/train_seg.txt'
        out_folder = f'/home/aranem_locale/Desktop/MICCAI_2023/experiments/UNet_VxM/unet_torch_250_{built_ts}_ce'
